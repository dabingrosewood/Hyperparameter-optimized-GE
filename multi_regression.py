...
def obj_func(x):
    ...
    cmd = 'python3 ponyge.py --parameters regression.txt'
    # cmd = 'python3 ponyge.py --parameters string_match.txt'
...
search_space=INITIALISATION+CROSSOVER+CROSSOVER_PROBABILITY+MUTATION+MUTATION_PROBABILITY+SELECTION+MAX_GENOME_LENGTH+MAX_INIT_TREE_DEPTH+MAX_TREE_DEPTH+TOURNAMENT_SIZE+SELECTION_PROPORTION+CODON_SIZE
