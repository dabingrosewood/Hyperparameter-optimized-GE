...
def print_best_ever():
    ...
    if hasattr(params['FITNESS_FUNCTION'], "training_test"):
        ...
        print('\n',trackers.best_ever.test_fitness)
    else:
        # print("\n\nBest:\n  Fitness:\t", trackers.best_ever.fitness)

        print(trackers.best_ever.fitness)


def store_best_ever():
    file=open('tmp_fitness','w')
    ...
    if hasattr(params['FITNESS_FUNCTION'], "training_test"):
        ...
        file.writelines(str(trackers.best_ever.test_fitness))
    else:
        # print("\n\nBest:\n  Fitness:\t", trackers.best_ever.fitness)

        file.writelines(str(trackers.best_ever.fitness))
